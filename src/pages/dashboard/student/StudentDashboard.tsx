      ...
      <div className='grid gap-4 xl:grid-cols-2'>
        <Card glow='violet' className='border-white/[0.08] bg-[#1a1825]'>
          <CardHeader className='mb-5'>
            ...
            <CardTitle>{t('dashboardStudentPrimaryTitle')}</CardTitle>
          </CardHeader>
          <CardContent>
            <p className='text-sm leading-6 text-[#b0aacd]'>
              {t('dashboardStudentPrimaryDescription')}
            </p>
            <Link
        ...
        <Card glow='sky' className='border-white/[0.08] bg-[#1a1825]'>
          <CardHeader className='mb-5'>
            ...
            <CardTitle>{t('dashboardStudentSecondaryTitle')}</CardTitle>
          </CardHeader>
          <CardContent>
            <p className='text-sm leading-6 text-[#b0aacd]'>
